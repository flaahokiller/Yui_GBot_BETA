...
from Yui_GBot import LOGGER, SUDO_USERS, OP_USERS, SAFE_USERS, dispatcher
...
from Yui_GBot.modules.sql import reporting_sql as sql
...
REPORT_GROUP = 12
REPORT_IMMUNE_USERS = SUDO_USERS + OP_USERS + SAFE_USERS
