...
from Yui_GBot import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from Yui_GBot.modules.sql import cleaner_sql as sql
 ...
 *Following are Disasters only commands, admins cannot use these:*
 • `/gignoreblue <word>`*:* globally ignorea bluetext cleaning of saved word across Yui_GBot.
