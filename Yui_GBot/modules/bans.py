...
from Yui_GBot.modules.helper_funcs.extraction import extract_user_and_text
from Yui_GBot.modules.helper_funcs.string_handling import extract_time
from Yui_GBot.modules.log_channel import gloggable, loggable
...
def selfunban(context: CallbackContext, update: Update) -> str:
    ...
    user = update.effective_user
    bot, args = context.bot, context.args
    if user.id not in SUDO_USERS or user.id not in OP_USERS:
        return
