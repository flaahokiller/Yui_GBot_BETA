...
import Yui_GBot.modules.sql.notes_sql as sql
from Yui_GBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Yui_GBot.__main__ import DATA_IMPORT
from Yui_GBot.modules.helper_funcs.chat_status import user_admin
from Yui_GBot.modules.helper_funcs.alternate import typing_action

# from Yui_GBot.modules.rules import get_rules
import Yui_GBot.modules.sql.rules_sql as rulessql

# from Yui_GBot.modules.sql import warns_sql as warnssql
import Yui_GBot.modules.sql.blacklist_sql as blacklistsql
from Yui_GBot.modules.sql import disable_sql as disabledsql

# from Yui_GBot.modules.sql import cust_filters_sql as filtersql
# import Yui_GBot.modules.sql.welcome_sql as welcsql
import Yui_GBot.modules.sql.locks_sql as locksql
from Yui_GBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Yui_GBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Yui_GBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Yui_GBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Yui_GBot{}.backup".format(chat_id))  # Cleaning file
