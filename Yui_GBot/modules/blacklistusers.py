...
import html
import Yui_GBot.modules.sql.blacklistusers_sql as sql
...
from Yui_GBot.modules.helper_funcs.chat_status import dev_plus
...
BLACKLISTWHITELIST = [OWNER_ID] + DEV_USERS + SUDO_USERS + SAFE_USERS + SUPPORT_USERS
...
def __user_info__(user_id):
    ...
    if user_id == dispatcher.bot.id:
        return ""
    if int(user_id) in SUDO_USERS + OP_USERS + SAFE_USERS:
        return ""
    if is_blacklisted:
